...
// AngularJS's events thrown via extension
export const EVENTS = {
    POINT_TO_POINT__OPEN_EDITOR: 'POINT_TO_POINT:OPEN_EDITOR',
    ROUTES__OPEN_IMPORT_POPUP: 'ROUTES:OPEN_IMPORT_POPUP',
    ROUTES__CLOSE_IMPORT_POPUP: 'ROUTES:CLOSE_IMPORT_POPUP',
    ROUTES__RELOAD_LIST: 'ROUTES:RELOAD_LIST',
};
